...
from formats.tlg0 import Tlg0
from formats.tlg5 import Tlg5
from formats.tlg6 import Tlg6
...
def _from_tlg5(file_name: str) -> Image:
    ...
    tlg = Tlg5.from_file(file_name)
    if tlg.header.colors != 3 and tlg.header.colors != 4:
        raise ValueError("Unsupported colors value: {}".format(tlg.header.colors))
